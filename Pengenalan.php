        ...
        <div>
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
                ...
                <div class="col-12">
                    ...
                    <li>
                        <a class="nav-item nav-link active" href="Pengenalan.php">Pengenalan<span class="sr-only">(current)</span></a>
                    </li>
                    <li>
                        <a class="nav-item nav-link" href="Informasi.php">Informasi</a>
                    </li>
                    <li>
                        <a class="nav-item nav-link" href="Galeri.php">Galeri<span class="sr-only">(current)</span></a>
                    </li>
                    <li>
